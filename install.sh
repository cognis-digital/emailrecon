#!/usr/bin/env sh
# Universal installer for emailrecon. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/emailrecon.git"
echo "Installing emailrecon ..."
