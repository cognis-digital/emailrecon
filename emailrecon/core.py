"""EMAILRECON core — Aggregate email OSINT (breach hints, MX, SPF/DMARC posture)."""
...
RULES = [
    ("EMA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("EMA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("EMA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
