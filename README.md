...
[![PyPI](https://img.shields.io/pypi/v/cognis-emailrecon.svg)](https://pypi.org/project/cognis-emailrecon/)
[![CI](https://github.com/cognis-digital/emailrecon/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/emailrecon/actions)
...
EMAILRECON exists for one job — aggregate email osint (breach hints, mx, spf/dmarc posture) — and does it without a SaaS bill or heavyweight setup.
...
```bash
emailrecon --version
emailrecon scan .                      # scan the current project
emailrecon scan . --format json
emailrecon scan . --fail-on high       # non-zero exit for CI gates
emailrecon mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **holehe**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`emailrecon` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
